...
export function Calendar() {
  ...
  return (
    <div className="flex h-screen bg-background">
      {/* Sidebar */}
      <div className={`border-r-2 bg-gray-50 flex flex-col transition-all duration-300 ${sidebarCollapsed ? 'w-0 overflow-hidden' : 'w-64'}`}>
        {!sidebarCollapsed && (
          <>
            {showMiniCalendar && (
              <div className="p-4 pb-2">
                <MiniCalendar selectedDate={selectedDate} onSelectDate={handleDateSelect} events={sampleCalendarEvents} />
