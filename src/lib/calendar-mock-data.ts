...
export const sampleCalendarEvents: CalendarEvent[] = [
  ...
  // ============================================
  // RUNNA SUBSCRIPTION SAMPLE RUNS (v1.3)
  // ============================================
  
  // Monday, Nov 24 - Easy Run (Runna)
  {
    id: 'runna-easy-run-nov24',
    user_id: 'demo-user-1',
    title: 'Easy Run – 45 min Z2',
    source: 'runna_subscription',
    date: '2024-11-24',
    start_time: '06:00:00',
    end_time: '07:00:00',
    type: 'run',
    ...
    json_payload: {
      ...
      duration_minutes: 45,
      zone: 'Z2',
      plan_name: 'Hyrox Dallas Plan',
      description: 'Easy conversational pace in Zone 2'
    },
    created_at: '2024-11-20T10:00:00Z',
    updated_at: '2024-11-20T10:00:00Z'
  },

  // Wednesday, Nov 26 - Tempo Run (Runna)
  {
    id: 'runna-tempo-run-nov26',
    user_id: 'demo-user-1',
    title: 'Tempo Run – 6 x 5 min @ Tempo',
    source: 'runna_subscription',
    date: '2024-11-26',
    start_time: '06:00:00',
    end_time: '07:00:00',
    ...
    json_payload: {
      ...
      target_pace: 'Tempo pace',
      recovery: '2 min easy jog between intervals',
      plan_name: 'Hyrox Dallas Plan',
      description: '6 x 5 minutes at tempo pace with 2 min recovery'
    },
    created_at: '2024-11-20T10:00:00Z',
    updated_at: '2024-11-20T10:00:00Z'
  },

  // Saturday, Nov 29 - Long Run (Runna)
  {
    id: 'runna-long-run-nov29',
    user_id: 'demo-user-1',
    title: 'Long Run – 90 min Z2',
    source: 'runna_subscription',
    date: '2024-11-29',
    start_time: '06:00:00',
    end_time: '07:30:00',
    ...
    json_payload: {
      ...
      zone: 'Z2',
      plan_name: 'Hyrox Dallas Plan',
      description: '90 minutes at easy conversational pace'
    },
    created_at: '2024-11-20T10:00:00Z',
    updated_at: '2024-11-20T10:00:00Z'
  },
